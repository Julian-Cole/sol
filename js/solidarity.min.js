...
var gblVersion="0.7",Solidarity={},sol=Solidarity,sh={},g={w:-1,h:-1,device:{isMobile:!1,isTablet:!1,isPC:!1},preferences:{date_format:1,sounds:!1},state:{bFirstRunSession:!1,isSplashScreen:!0,isChannelExists:!1},solid:{sh:{},pod:{},session:{},pti:{},name:"",photo:"",friends:{list:[],count:0,webIds:[],onAllFriendsLoaded_Callback:function(){}},role:{},storage:{},inbox:{},isLogged:!1,webId:"",instances:{longchat:"",chat:""},websockets:function(){},websockets_attached:!1},date:{day:"",month:"",year:"",
...
function crypto_getSHA1Hash(a){var b=new jsSHA("SHA-1","TEXT");b.update(a);return b.getHash("HEX")}function crypto_vernam(a,b){var c=b.length,d=String.fromCharCode;return a.replace(/[\s\S]/g,function(a,k){return d(b.charCodeAt(k%c)^a.charCodeAt(0))})}(function(a){a.fn.hasScrollBar=function(){return this.get(0).scrollHeight>this.height()}})(jQuery);String.prototype.contains=function(a){return-1!==this.indexOf(a)};String.prototype.searchAndReplace=function(a,b){return this.split(a).join(b)};
function clone_jquery(a){return $.extend(!0,{},a)}function clone_jq(a){return $.extend(!0,{},a)}Object.size=function(a){var b=0,c;for(c in a)a.hasOwnProperty(c)&&b++;return b};
...
g.w-80),$("#div_chatviewportbg").css("height",g.h-190).css("width",g.w-258),$("#div_chatter_container").css("width",g.w-267).css("height",g.h-280),$("#div_inputconsole__loggedin__avatar_container").css("left",225).css("top",g.h-110),$("#div_chatviewport_inputconsole").css("top",g.h-120).css("width",g.w-343),$("#modal_preferences").css("width",400),$("#logged_in_pc").css("left",g.w-324).css("top",g.h-90),g.state.isSplashScreen&&($("#div_index_splash_pc").css("display","inline"),$("#div_index_splash_tab").css("display",
"none"),$("#div_index_splash_mob").css("display","none")));g.device.isTablet&&($("#div_mob_chatviewportbg").css("width",g.w).css("height",g.h-40),$("#div_mob_chatter_container").css("width",g.w).css("height",g.h-120),$("#div_mob_inputconsole__loggedin__avatar_container").css("left",5).css("top",g.h-50+3),$("#div_mob_chatviewport_inputconsole").css("top",g.h-65).css("width",g.w-41),$("#modal_preferences").css("width",300),g.state.isSplashScreen&&($("#div_index_splash_pc").css("display","none"),$("#div_index_splash_tab").css("display",
"inline"),$("#div_index_splash_mob").css("display","none")));g.device.isMobile&&($("#div_mob_chatviewportbg").css("width",g.w).css("height",g.h-40),$("#div_mob_chatter_container").css("width",g.w).css("height",g.h-120),$("#div_mob_inputconsole__loggedin__avatar_container").css("left",5).css("top",g.h-50+3),$("#div_mob_chatviewport_inputconsole").css("top",g.h-65).css("width",g.w-41),$("#modal_preferences").css("width",300),g.state.isSplashScreen&&($("#div_index_splash_pc").css("display","none"),$("#div_index_splash_tab").css("display",
"none"),$("#div_index_splash_mob").css("display","inline")))},DeviceView:function(){0<g.w&737>g.w&&(g.device.isPC=!1,g.device.isTablet=!1,g.device.isMobile=!0,$("#div_pc").css("display","none"),$("#div_tab").css("display","none"),$("#div_mob").css("display","inline"));736<g.w&1068>g.w&&(g.device.isPC=!1,g.device.isTablet=!0,g.device.isMobile=!1,$("#div_pc").css("display","none"),$("#div_tab").css("display","none"),$("#div_mob").css("display","inline"));1067<g.w&&(g.device.isPC=!0,g.device.isTablet=
!1,g.device.isMobile=!1,$("#div_pc").css("display","inline"),$("#div_tab").css("display","none"),$("#div_mob").css("display","none"))}}};window.onresize=function(){g.w=$(window).width();g.h=$(window).height();Solidarity.Responsive.DeviceView();Solidarity.Responsive.ArrangeViewport()};Templates.template_list.push({name:"ListSimple",value:'<p>@lbl_header@</p><ul id="@ID@" style="list-style-type:none;">@BODY@</ul><p>@lbl_footer@</p><div><button onclick="javascript:@INSTANCE@_add();" type="button">Add</button><button onclick="javascript:@INSTANCE@_edit();" type="button">Edit</button><button onclick="javascript:@INSTANCE@_remove();" type="button">remove</button></div>'});
...
$(".ui.checkbox").checkbox();g.device.isPC&&$("#div_index_splash_pc").css("display","inline");g.device.isTablet&&$("#div_index_splash_mob").css("display","inline");g.device.isMobile&&$("#div_index_splash_mob").css("display","inline");var b=showdown.getDefaultOptions();trace(b);showdown.setOption("ghMentions","true");showdown.setOption("emoji","true");showdown.setOption("tasklists","true");showdown.setOption("ghMentionsLink","javascript:solid_inbox__mentions_clicked('{u}');");g.solid.sh=new Shighl;
g.solid.session=new g.solid.sh.session;g.solid.pod=new g.solid.sh.pod;b=g.solid.sh.version;$("#sp_lblSplashVersion").html("v&nbsp;"+gblVersion+" / "+(null==b?"n/a":b));$("#sp_lblSplashVersionTab").html("v&nbsp;"+gblVersion+" / "+(null==b?"n/a":b));$("#sp_lblSplashVersionMob").html("v&nbsp;"+gblVersion+" / "+(null==b?"n/a":b));(function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){return b.yield(g.solid.session.track(a),0)})})();$("#div_chatter_container").scroll(function(){0==
...
$("#frm_tab_lc_text_input").blur());g.device.isMobile&&(a=$("#frm_mob_lc_text_input").val().trim(),$("#frm_mob_lc_text_input").val(""),$("#frm_mob_lc_text_input").blur());b=g.active_channel.chat_messages[g.active_channel.chat_messages.length-1];c=b.url;d=b.maker;e="InstantMessage";k={content:a,webId:g.solid.webId,postType:e,replyTo:c};g.active_channel.chat.message=k;if(!(0<d.length))return v.jumpTo(0);console.log("author",d);trace("--------------------------------");trace("replyTo="+c);trace(" author="+
d);trace("postType="+e);trace("--------------------------------");f=g.active_channel.chat.lastPost;l=g.solid.sh.pod();console.log("pod",l);l.webId=d;console.log("pod",l);n=h=new sh.inbox;return v.yield(l.inbox,4)}n.inbox=v.yieldResult;console.log("ib",h);w={sender:g.solid.webId,title:"solidarity reply",url:f,content:f+" is a "+e+" reply to' "+c,replyTo:c};h.message=w;v.jumpToEnd()})}function solid_long_chat__subscribe_onReceivedMessage(){solid_long_chat__initLongChatInstance(!0)}
function solid_long_chat__setChannel(a,b){trace("!!!!! ONLY BE CALLED ONCE!!!!!!  solid_long_chat__setChannel() -> FIRED!");solid_long_chat__getPublicTypeIndex(a+"/profile/card#me",a,b)}function solid_friends__getFriends(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(a){trace("solid_login__getFriends() -> FIRED!");sapi.getFriends(g.solid.webId,solid_friends__getStatusOfFriends);a.jumpToEnd()})}
