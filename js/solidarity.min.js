...
this.onSettledCallbacks_=null}};var k=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(n){c.reject(n)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(A){f(A)}}:b}var d,f,l=new e(function(a,b){d=a;f=b});this.callWhenSettled_(c(a,d),c(b,f));return l};
...
$jscomp.asyncExecutePromiseGenerator=function(a){function b(b){return a.next(b)}function c(b){return a.throw(b)}return new Promise(function(d,e){function k(a){a.done?d(a.value):Promise.resolve(a.value).then(b,c).then(k,e)}k(a.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(a){return $jscomp.asyncExecutePromiseGenerator(a())};$jscomp.asyncExecutePromiseGeneratorProgram=function(a){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(a)))};
$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},b=Object.create(new $jscomp.global.Proxy(a,{get:function(c,d,e){return c==a&&"q"==d&&e==b}}));return!0===b.q}catch(c){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),d=new a([[b,2],[c,3]]);if(2!=d.get(b)||3!=d.get(c))return!1;d.delete(b);d.set(c,4);return!d.has(b)&&4==d.get(c)}catch(x){return!1}}function c(){}function d(a){var b=typeof a;return"object"===b&&null!==a||"function"===b}function e(a){if(!$jscomp.owns(a,f)){var b=new c;$jscomp.defineProperty(a,f,{value:b})}}function k(a){var b=Object[a];b&&(Object[a]=function(a){if(a instanceof
c)return a;e(a);return b(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var f="$jscomp_hidden_"+Math.random();k("freeze");k("preventExtensions");k("seal");var l=0,h=function(a){this.id_=(l+=Math.random()+1).toString();if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};h.prototype.set=function(a,b){if(!d(a))throw Error("Invalid WeakMap key");e(a);if(!$jscomp.owns(a,f))throw Error("WeakMap key fail: "+
...
d||"function"==d?c.has(b)?d=c.get(b):(d=""+ ++l,c.set(b,d)):d="p_"+b;var e=a.data_[d];if(e&&$jscomp.owns(a.data_,d))for(a=0;a<e.length;a++){var f=e[a];if(b!==b&&f.key!==f.key||b===f.key)return{id:d,list:e,index:a,entry:f}}return{id:d,list:e,index:-1,entry:void 0}},k=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},f=function(){var a={};return a.previous=
a.next=a.head=a},l=0;return d},"es6","es3");
$jscomp.polyfill("Set",function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_SET||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),c=new a($jscomp.makeIterator([b]));if(!c.has(b)||1!=c.size||c.add(b)!=c||1!=c.size||c.add({x:4})!=c||2!=c.size)return!1;var k=c.entries(),f=k.next();if(f.done||f.value[0]!=b||f.value[1]!=b)return!1;f=k.next();return f.done||f.value[0]==b||4!=f.value[0].x||f.value[1]!=f.value[0]?!1:k.next().done}catch(l){return!1}}
...
var gblVersion="0.7.1",Solidarity={},sol=Solidarity,sh={},g={w:-1,h:-1,device:{isMobile:!1,isTablet:!1,isPC:!1},preferences:{date_format:1,sounds:!1},state:{bFirstRunSession:!1,isSplashScreen:!0,isChannelExists:!1},solid:{sh:{},pod:{},session:{},pti:{},name:"",photo:"",friends:{list:[],count:0,webIds:[],onAllFriendsLoaded_Callback:function(){}},role:{},storage:{},inbox:[],isLogged:!1,webId:"",instances:{longchat:"",chat:""},websockets:function(){},websockets_attached:!1},date:{day:"",month:"",year:"",
offset:0},active_channel:{sh:{},pod:{},pti:{},name:"",photo:"",friends:{},role:{},storage:{},long_chat_instance:{},chat:{},chat_pages:{},chat_messages:[],chat_messages_postfix:[],chat_messages_prefix:[],bPullFromLocalStor:!1,long_chat_instance_isPrivate:!1},favourite_channels:{selected:0,list:[{channel_name:"Solidarity",channel_url:"https://solidarity.inrupt.net"},{channel_name:"Shighl/Shighl",channel_url:"https://solidarity.inrupt.net"}]}},TYPE_LONG_CHAT_RENDER_MODE={TYPE_REPLACE:0,TYPE_PREFFIX:1,
TYPE_POSTFIX:2},UIX={Mobile:{BurgerMenuShow:function(){TweenMax.to($("#mobile_burger_menu_slideout"),.25,{width:g.w,delay:.5})},UserMenuShow:function(){},MainMenuShow:function(){}}},db_findingChannelInstance=!1,db_chatPages=!1,db_chatMessages=!1;function trace(a){console.log(a)}function setScrollerToBottom(a){a=document.getElementById(a);a.scrollTop=a.scrollHeight}function padLeadingZero(a){return 10>a?"0"+a:a}function trimTrailingChars(a,b){return a.replace(new RegExp(b+"+$"),"")}
function openwindow(a){return(a=window.open(a,"_blank"))?(a.focus(),!0):!1}function crypto_getSHA1Hash(a){var b=new jsSHA("SHA-1","TEXT");b.update(a);return b.getHash("HEX")}function crypto_vernam(a,b){var c=b.length,d=String.fromCharCode;return a.replace(/[\s\S]/g,function(a,k){return d(b.charCodeAt(k%c)^a.charCodeAt(0))})}(function(a){a.fn.hasScrollBar=function(){return this.get(0).scrollHeight>this.height()}})(jQuery);String.prototype.contains=function(a){return-1!==this.indexOf(a)};
String.prototype.searchAndReplace=function(a,b){return this.split(a).join(b)};function clone_jquery(a){return $.extend(!0,{},a)}function clone_jq(a){return $.extend(!0,{},a)}Object.size=function(a){var b=0,c;for(c in a)a.hasOwnProperty(c)&&b++;return b};
var clone=function(){function a(b,l,h,n,w){function f(b,h){if(null===b)return null;if(0===h||"object"!=typeof b)return b;if(b instanceof d)var m=new d;else if(b instanceof e)m=new e;else if(b instanceof k)m=new k(function(a,c){b.then(function(b){a(f(b,h-1))},function(a){c(f(a,h-1))})});else if(a.__isArray(b))m=[];else if(a.__isRegExp(b))m=new RegExp(b.source,c(b)),b.lastIndex&&(m.lastIndex=b.lastIndex);else if(a.__isDate(b))m=new Date(b.getTime());else{if(z&&Buffer.isBuffer(b))return m=new Buffer(b.length),
b.copy(m),m;if(b instanceof Error)m=Object.create(b);else if("undefined"==typeof n){var q=Object.getPrototypeOf(b);m=Object.create(q)}else m=Object.create(n),q=n}if(l){var p=x.indexOf(b);if(-1!=p)return y[p];x.push(b);y.push(m)}if(b instanceof d)for(p=b.keys();;){var t=p.next();if(t.done)break;var v=f(t.value,h-1);t=f(b.get(t.value),h-1);m.set(v,t)}if(b instanceof e)for(p=b.keys();;){t=p.next();if(t.done)break;t=f(t.value,h-1);m.add(t)}for(var r in b){var u;q&&(u=Object.getOwnPropertyDescriptor(q,
r));u&&null==u.set||(m[r]=f(b[r],h-1))}if(Object.getOwnPropertySymbols)for(u=Object.getOwnPropertySymbols(b),r=0;r<u.length;r++)if(p=u[r],q=Object.getOwnPropertyDescriptor(b,p),!q||q.enumerable||w)m[p]=f(b[p],h-1),q.enumerable||Object.defineProperty(m,p,{enumerable:!1});if(w)for(u=Object.getOwnPropertyNames(b),r=0;r<u.length;r++)p=u[r],q=Object.getOwnPropertyDescriptor(b,p),q&&q.enumerable||(m[p]=f(b[p],h-1),Object.defineProperty(m,p,{enumerable:!1}));return m}"object"===typeof l&&(h=l.depth,n=l.prototype,
w=l.includeNonEnumerable,l=l.circular);var x=[],y=[],z="undefined"!=typeof Buffer;"undefined"==typeof l&&(l=!0);"undefined"==typeof h&&(h=Infinity);return f(b,h)}function b(a){return Object.prototype.toString.call(a)}function c(a){var b="";a.global&&(b+="g");a.ignoreCase&&(b+="i");a.multiline&&(b+="m");return b}try{var d=Map}catch(f){d=function(){}}try{var e=Set}catch(f){e=function(){}}try{var k=Promise}catch(f){k=function(){}}a.clonePrototype=function(a){if(null===a)return null;var b=function(){};
...
($("#div_index_splash_pc").css("display","inline"),$("#div_index_splash_tab").css("display","none"),$("#div_index_splash_mob").css("display","none")));g.device.isTablet&&($("#div_mob_chatviewportbg").css("width",g.w).css("height",g.h-40),$("#div_mob_chatter_container").css("width",g.w).css("height",g.h-120),$("#div_mob_inbox_container").css("width",g.w-15).css("height",g.h-10),$("#div_mob_inbox_container__msg_view").css("width",g.w-15).css("height",g.h-10),$("#div_mob_inputconsole__loggedin__avatar_container").css("left",
5).css("top",g.h-50+3),$("#div_mob_chatviewport_inputconsole").css("top",g.h-65).css("width",g.w-41),$("#modal_preferences").css("width",350),$("#modal_add_channel").css("width",350),$("#modal_manage_channels").css("width",350),g.state.isSplashScreen&&($("#div_index_splash_pc").css("display","none"),$("#div_index_splash_tab").css("display","inline"),$("#div_index_splash_mob").css("display","none")));g.device.isMobile&&($("#div_mob_chatviewportbg").css("width",g.w).css("height",g.h-40),$("#div_mob_chatter_container").css("width",
g.w).css("height",g.h-120),$("#div_mob_inbox_container").css("width",g.w-15).css("height",g.h-10),$("#div_mob_inbox_container__msg_view").css("width",g.w-15).css("height",g.h-10),$("#div_mob_inputconsole__loggedin__avatar_container").css("left",5).css("top",g.h-50+3),$("#div_mob_chatviewport_inputconsole").css("top",g.h-65).css("width",g.w-41),$("#modal_preferences").css("width",350),$("#modal_add_channel").css("width",350),$("#modal_manage_channels").css("width",350),g.state.isSplashScreen&&($("#div_index_splash_pc").css("display",
"none"),$("#div_index_splash_tab").css("display","none"),$("#div_index_splash_mob").css("display","inline")))},DeviceView:function(){0<g.w&737>g.w&&(g.device.isPC=!1,g.device.isTablet=!1,g.device.isMobile=!0,$("#div_pc").css("display","none"),$("#div_tab").css("display","none"),$("#div_mob").css("display","inline"));736<g.w&1068>g.w&&(g.device.isPC=!1,g.device.isTablet=!0,g.device.isMobile=!1,$("#div_pc").css("display","none"),$("#div_tab").css("display","none"),$("#div_mob").css("display","inline"));
1067<g.w&&(g.device.isPC=!0,g.device.isTablet=!1,g.device.isMobile=!1,$("#div_pc").css("display","inline"),$("#div_tab").css("display","none"),$("#div_mob").css("display","none"))}}};window.onresize=function(){g.w=$(window).width();g.h=$(window).height();Solidarity.Responsive.DeviceView();Solidarity.Responsive.ArrangeViewport()};Templates.template_list.push({name:"ListSimple",value:'<p>@lbl_header@</p><ul id="@ID@" style="list-style-type:none;">@BODY@</ul><p>@lbl_footer@</p><div><button onclick="javascript:@INSTANCE@_add();" type="button">Add</button><button onclick="javascript:@INSTANCE@_edit();" type="button">Edit</button><button onclick="javascript:@INSTANCE@_remove();" type="button">remove</button></div>'});
...
function Pod(a){var b=this,c,d,e,k,f,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return b.sh=new Shighl,b.pod=new sh.pod,b.pod.webId=a,c=b,h.yield(pod.name,2);case 2:return c.name=h.yieldResult,d=b,h.yield(pod.photo,3);case 3:return d.photo=h.yieldResult,e=b,h.yield(pod.friends,4);case 4:return e.friends=h.yieldResult,k=b,h.yield(pod.pti,5);case 5:return k.pti=h.yieldResult,f=b,h.yield(pod.role,6);case 6:return f.role=h.yieldResult,l=b,h.yield(pod.storage,
7);case 7:l.storage=h.yieldResult,h.jumpToEnd()}})}
...
function solid_long_chat__getPublicTypeIndex(a,b,c){var d,e,k,f,l,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return db_findingChannelInstance&&trace("Trying to retrieve PublicTypeInstance for "+a),g.active_channel.sh=new Shighl,g.active_channel.pod=new g.active_channel.sh.pod,g.active_channel.pod.webId=a,d=g.active_channel,n.yield(g.active_channel.pod.pti,2);d.pti=n.yieldResult;db_findingChannelInstance&&trace(g.active_channel.pti);e=b;k=c;f=e+"/public/"+
k+"/index.ttl#this";l=e+"/private/"+k+"/index.ttl#this";h=!1;db_findingChannelInstance&&trace("Searching for Long-chat channel: "+f+" in the public type index");g.active_channel.pti.instances.forEach(function(a){db_findingChannelInstance&&(trace("searching PTI for.. "+f),trace(a));"LongChat"==a.shortClass&(a.url==f|a.url==l)&&(a.url==l?(db_findingChannelInstance&&trace("This chat is PRIVATE"),g.active_channel.long_chat_instance_isPrivate=!0):(db_findingChannelInstance&&trace("This chat is PUBLIC"),
g.active_channel.long_chat_instance_isPrivate=!1),db_findingChannelInstance&&trace("Found Target long-chat CHANNEL"),h=a,g.active_channel.long_chat_instance=a)});db_findingChannelInstance&&trace(h);solid_long_chat__initLongChatInstance(!1);n.jumpToEnd()})}
...
function solid_long_chat__renderMessages(a){db_chatMessages&&trace(g.active_channel.chat_messages);var b=new showdown.Converter,c="",d=[];a.type==TYPE_LONG_CHAT_RENDER_MODE.TYPE_REPLACE&&($("#div_chatter_container").html(""),d=g.active_channel.chat_messages);a.type==TYPE_LONG_CHAT_RENDER_MODE.TYPE_POSTFIX&&(d=g.active_channel.chat_messages_postfix);a.type==TYPE_LONG_CHAT_RENDER_MODE.TYPE_PREFFIX&&(d=g.active_channel.chat_messages_prefix);trace("MESSAGES TO RENDER "+d.length);for(var e=0;e<d.length;e++){var k=
d[e];db_chatMessages&&trace(k);var f="";void 0!=k.maker&&(g.device.isPC&&(f=Templates.Get("Chatter_Item")),g.device.isMobile|g.device.isTablet&&(f=Templates.Get("Chatter_Item_mob")),"undefined"!=k.makerimg?f=f.searchAndReplace("@AVATAR@","https://images.weserv.nl/?url="+k.makerimg+"&w=29&h=29"):f=f.searchAndReplace("@AVATAR@","images/no-avatar.png"),f=f.searchAndReplace("@LBL_NAME@",k.makername),f=f.searchAndReplace("@LBL_WEBID@",k.maker),f=a.type==TYPE_LONG_CHAT_RENDER_MODE.TYPE_POSTFIX|a.type==
TYPE_LONG_CHAT_RENDER_MODE.TYPE_PREFFIX?f.searchAndReplace("@BORDER@","solid"):f.searchAndReplace("@BORDER@","none"),f=f.searchAndReplace("@LBL_CONTENT@",b.makeHtml(k.content)),db_chatMessages&&trace("####### Date="+k.date),db_chatMessages&&trace("### TZOffset="+g.date.offset),f=f.searchAndReplace("@LBL_TIME@",0==g.preferences.date_format?jQuery.timeago(new Date(k.date)):moment(new Date(k.date)).add(g.date.offset,"hours").format("MMM Do YYYY, h:mm a")),c+=f)}g.device.isPC&&(a.type==TYPE_LONG_CHAT_RENDER_MODE.TYPE_REPLACE&&
...
function solid_long_chat__sendMessage(){var a,b,c,d,e,k,f,l,h,n,w;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){if(1==v.nextAddress){trace("solid_long_chat__sendMessage() -> FIRED!");a="";if(!g.solid.isLogged)return alert("you must be logged into your Solid account to send messages!!"),v.jumpTo(0);g.device.isPC&&(a=$("#frm_lc_text_input").val().trim(),$("#frm_lc_text_input").val(""),$("#frm_lc_text_input").blur());g.device.isTablet&&(a=$("#frm_tab_lc_text_input").val().trim(),$("#frm_tab_lc_text_input").val(""),
$("#frm_tab_lc_text_input").blur());g.device.isMobile&&(a=$("#frm_mob_lc_text_input").val().trim(),$("#frm_mob_lc_text_input").val(""),$("#frm_mob_lc_text_input").blur());b=g.active_channel.chat_messages[g.active_channel.chat_messages.length-1];c=b.url;d=b.maker;e="InstantMessage";k={content:a,webId:g.solid.webId,postType:e,replyTo:c};g.active_channel.chat.message=k;solid_long_chat__suppress_self_send_notif=!0;if(!(0<d.length))return v.jumpTo(0);console.log("author",d);trace("--------------------------------");
trace("replyTo="+c);trace(" author="+d);trace("postType="+e);trace("--------------------------------");f=g.active_channel.chat.lastPost;l=g.solid.sh.pod();console.log("pod",l);l.webId=d;console.log("pod",l);n=h=new sh.inbox;return v.yield(l.inbox,4)}n.inbox=v.yieldResult;console.log("ib",h);w={sender:g.solid.webId,title:"solidarity reply",url:f,content:f+" is a "+e+" reply to' "+c,replyTo:c};h.message=w;v.jumpToEnd()})}var solid_long_chat__suppress_self_send_notif=!1;
...
function solid_friends__renderFriends(){trace("solid_login__renderFriends() -> FIRED!");$("#lbl_friends_count").html("&nbsp;("+g.solid.friends.list.length+")");for(var a=Templates.Get("Friend_Item"),b="",c=0;c<g.solid.friends.list.length;c++){trace("RENDERING FRIEND... "+c);b+=a.searchAndReplace("@AVATAR@",sapi.getFriendPropertiesByFriendIndex(g.solid.friends.list,c,"hasPhoto"));var d=sapi.getFriendPropertiesByFriendIndex(g.solid.friends.list,c,"status"),e=!1;sapi.getFriendPropertiesByFriendIndex(g.solid.friends.list,
c,"fn");switch(d){case "online":e="green";break;case "away":e="yellow";break;case "busy":e="red";break;case "offline":e=!1}e?(b=b.searchAndReplace("@STATUS@",'<a class="ui '+e+' empty circular label"></a>'),b=b.searchAndReplace("@OPACITY@","1")):(b=b.searchAndReplace("@STATUS@",""),b=b.searchAndReplace("@OPACITY@","0.4"))}b+='<div style="clear:both;"></div>';$("#div_pc_friends_list").html(b)}
function solid_friends__getStatusOfMe(){sapi.readFileParams(g.solid.storage+"public/apps/solidarity/status.json",solid_friends__getStatusOfMe__onComplete,{index:-1})}
...
sapi.readFolder(d+"/"+e[0]+"/"+k[0]+"/"+f[0],a)}function c(a){trace("checkChatFolderMonth() -> FIRED!");trace(a);for(var c=0;c<a.folders.length;c++)k.push(a.folders[c].name);k.reverse();sapi.readFolder(d+"/"+e[0]+"/"+k[0],b)}g.state.isChannelExists=!1;trace("solid_channels__checkChatExists() -> FIRED!");$("#div_modal_add_channel_validating").css("display","inline-block");$("#div_modal_add_channel_success").css("display","none");$("#div_modal_add_channel_fail").css("display","none");var d=$("#frm_add_channel_url").val().trim()+
"/public/"+$("#frm_add_channel_name").val().trim().split(" ").join(""),e=[],k=[],f=[];sapi.readFolder(d,function(a){trace("checkChatFolderYear() -> FIRED!");trace(a);for(var b=0;b<a.folders.length;b++)e.push(a.folders[b].name);e.reverse();sapi.readFolder(d+"/"+e[0],c)})}function solid_inbox__mentions_clicked(a){}
function solid_inbox__init(){trace("solid_inbox__init() -> FIRED!");trace("inbox location..");trace("https://"+g.solid.webId.split("/")[2]+"/inbox/");sapi.readFolder("https://"+g.solid.webId.split("/")[2]+"/inbox/",solid_inbox__onInboxDirLoaded)}var solid_inbox__messageCount=0,solid_inbox__messageTotal=0;
...
function solid_inbox__renderInbox(){trace("solid_inbox__renderInbox() -> FIRED!");trace("g.solid.inbox=");trace(g.solid.inbox);for(var a="",b,c=0;c<g.solid.inbox.length;c++){var d=g.solid.inbox[c];b=Templates.Get("Inbox_Item");b=b.searchAndReplace("@SENDER@",d.sender.split("://")[1].split(".")[0]);b=b.searchAndReplace("@DATETIME@",d.date);b=b.searchAndReplace("@TEXT@",d.label);b=b.searchAndReplace("@ID@",c);a+=b}$("#div_mob_inbox_container").html(a)}
function solid_inbox__showInbox(){$("#div_mob_inbox_container").css("display","inline");$("#div_mob_inbox_contols").css("display","inline");$("#div_mob_inbox_contols").css("display","inline")}function solid_inbox__hideInbox(){$("#div_mob_inbox_container").css("display","none");$("#div_mob_inbox_contols").css("display","none");$("#div_mob_inbox_contols__messageview").css("display","none");$("#div_mob_inbox_container__msg_view").css("display","none")}
function solid_inbox__messageView_checkbox_onclick(a){trace(a)}
function solid_inbox__messageView_onclick(a){trace(a);$("#div_mob_inbox_container").css("display","none");$("#div_mob_inbox_contols").css("display","none");$("#div_mob_inbox_contols__messageview").css("display","inline");$("#div_mob_inbox_container__msg_view").css("display","inline");a=g.solid.inbox[a];var b=Templates.Get("Inbox_Item_Message");b=b.searchAndReplace("@SENDER@",a.sender.split("://")[1].split(".")[0]);b=b.searchAndReplace("@DATETIME@",a.date);b=b.searchAndReplace("@TEXT@",a.label);$("#div_mob_inbox_container__msg_view").html(b)}
function solid_inbox__messageView_onclick_back(){$("#div_mob_inbox_contols__messageview").css("display","none");$("#div_mob_inbox_container__msg_view").css("display","none");$("#div_mob_inbox_contols").css("display","inline");$("#div_mob_inbox_container").css("display","inline")}function solid_inbox__updateMessageListCount(){$("#div_mob_inbox_contols__lbl_msg_count").html("Messages ("+g.solid.inbox.length+") &nbsp;&nbsp;&nbsp;")}
...
function WSWatcher(a){trace("XXXXXXXXXXXXXXXX new WSWatcher() -> FIRED!");this._onChangeCounter=0;this._name=a.name;this._socket={};this.url=a.url;this.resource=a.resource;this.data=a.data;this.callback=a.callback;this.onChangeCounterThreshold=a.onChangeCounterThreshold;this.isOneTimeWatcher=a.isOneTimeWatcher}
...
b.data.slice(0,3)&&(trace(b),a.callback(a._name))}}catch(c){}}}function install__installApplicationFolders(){trace("install__installApplicationFolders() -> FIRED!");solid.createFile(g.solid.storage+"public/apps/solidarity/status.json",'{"status":"offline"}',install__installApplicationFolders__onComplete)}function install__installApplicationFolders__onComplete(a){trace("install__installApplicationFolders__onComplete() -> FIRED! success="+a)}
function install__installApplicationFolderApps__onComplete(a){trace("install__installApplicationFolderApps__onComplete() -> FIRED!");a?install__installApplicationFolders():trace(g.solid.storage+"public/Apps  Failed to be created in your pod!")};
